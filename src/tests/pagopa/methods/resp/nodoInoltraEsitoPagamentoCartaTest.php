...
class nodoInoltraEsitoPagamentoCartaTest extends TestCase
{
    ...
    {
        $this->event = new nodoInoltraEsitoPagamentoCarta(base64_decode('eyJlc2l0byI6Ik9LIn0='));
    }

    #[TestDox('outcome()')]
    public function testOutcome()
    {
        $this->assertEquals('OK', $this->event->outcome());
    }
    ...
    {
        $this->assertNull($this->event->getBrokerPsp());
    }
    ...
    {
        $this->assertNull($this->event->getImportoTotale());
    }
    ...
    {
        $this->assertNull($this->event->getCanale());
    }
    ...
    {
        $this->assertNull($this->event->getPsp());
    }
