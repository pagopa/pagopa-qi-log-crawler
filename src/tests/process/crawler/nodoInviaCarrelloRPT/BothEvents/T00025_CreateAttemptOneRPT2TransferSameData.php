 ...
 *            <td style="padding: 8px">c0000000000000000000000000000011</td>
 *          </tr>
 *      </tbody>
 *  </table>
 *
 ...
 *     <tbody>
 *         <tr style="border-bottom: 1px dashed;">
 *          <td style="border-right: 1px dashed;padding: 10px">01000000000000021</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 *           <td style="padding: 10px">t0000000000000000000000000000021</td>
 *         </tr>
 *     </tbody>
 *     <tfoot>
 ...
 *            <td style="padding: 10px">2024-03-10 10:33:00.197</td>
 *          </tr>
 *          <tr style="border-bottom: 1px dashed;">
 *             <td style="border-right: 1px dashed;padding: 10px">T000027</td>
 *             <td style="border-right: 1px dashed;padding: 10px">4</td>
 *             <td style="padding: 10px">2024-03-10 10:34:00.197</td>
 *          </tr>
 *      </tbody>
 *      <tfoot>
 *          <tr style="padding: 10px">
...
#[TestDox('[T00025] Valuta la corretta lavorazione di una nodoInviaCarrelloRPT REQ/RESP con 1 RPT e 2 Transfer Avvenute nella stessa data')]
class T00025_CreateAttemptOneRPT2TransferSameData extends TestCase
{
    ...
    public function testTransaction()
    {
        ...
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-10'), '01000000000000021');
        $this->assertEquals('2024-03-10 10:33:00.197', $transaction->getColumnValue('inserted_timestamp'));
        $this->assertEquals('01000000000000021', $transaction->getColumnValue('iuv'));
        $this->assertEquals('77777777777', $transaction->getColumnValue('pa_emittente'));
        $this->assertEquals('t0000000000000000000000000000021', $transaction->getColumnValue('token_ccp'));
    ...
    public function testWorkFlow()
    {
        ...
        $this->assertEquals('2024-03-10 10:33:00.197', $workflow->getColumnValue('event_timestamp'));
        $this->assertEquals('T000026', $workflow->getColumnValue('event_id'));
        ...
        $this->assertEquals('2024-03-10 10:34:00.197', $workflow->getColumnValue('event_timestamp'));
        $this->assertEquals('T000027', $workflow->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $workflow->getColumnValue('stazione'));
    }
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 26);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 27);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));
    }
