 ...
 *     <tbody>
 *         <tr style="border-bottom: 1px dashed;">
 *           <td style="border-right: 1px dashed;padding: 10px">01000000000000012</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 *           <td style="padding: 10px">t0000000000000000000000000000012</td>
 *         </tr>
 *     </tbody>
 *     <tfoot>
 ...
 *     <tbody>
 *         <tr style="border-bottom: 1px dashed;">
 *           <td style="border-right: 1px dashed;padding: 10px">355.00</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 *           <td style="padding: 10px">IT18U0000000000000000000010</td>
 *         </tr>
 *         <tr style="border-bottom: 1px dashed;">
 *           <td style="border-right: 1px dashed;padding: 10px">300.00</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 ...
 *      <tbody>
 *          <tr style="border-bottom: 1px dashed;">
 *            <td style="border-right: 1px dashed;padding: 10px">T000022</td>
 *            <td style="border-right: 1px dashed;padding: 10px">3</td>
 *            <td style="padding: 10px">2024-03-10 10:21:00.197</td>
 *          </tr>
 *      </tbody>
 *      <tfoot>
 *          <tr style="padding: 10px">
...
#[TestDox('[T00021] Valuta la corretta lavorazione di una singola nodoInviaCarrelloRPT Request con 1 RPT e 2 Transfer')]
class T00021_CreateAttemptOneRPTTwoTransfer extends TestCase
{
    ...
    public function testTransaction()
    {
        ...
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-10'), '01000000000000012');
        $this->assertEquals('2024-03-10 10:21:00.197', $transaction->getColumnValue('inserted_timestamp'));
        $this->assertEquals('01000000000000012', $transaction->getColumnValue('iuv'));
        $this->assertEquals('77777777777', $transaction->getColumnValue('pa_emittente'));
        $this->assertEquals('t0000000000000000000000000000012', $transaction->getColumnValue('token_ccp'));
        $this->assertEquals('c0000000000000000000000000000002', $transaction->getColumnValue('id_carrello'));
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 21);
