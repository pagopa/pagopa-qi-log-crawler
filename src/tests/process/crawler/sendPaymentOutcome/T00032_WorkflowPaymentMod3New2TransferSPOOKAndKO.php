 ...
 *
 */
#[TestDox('[T00032] Valuta la corretta lavorazione di un workflow di pagamento MOD3 NEW con 2 transfer e una sendPaymentOutcome prima OK e poi KO')]
class T00032_WorkflowPaymentMod3New2TransferSPOOKAndKO extends TestCase
{
    ...
    {
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-10'), '01000000000000032');

        $this->assertEquals('2024-03-10', $transaction->getColumnValue('date_event'));
        $this->assertEquals('2024-03-10 13:30:00.197', $transaction->getColumnValue('inserted_timestamp'));
        $this->assertEquals('01000000000000032', $transaction->getColumnValue('iuv'));
        $this->assertEquals('77777777777', $transaction->getColumnValue('pa_emittente'));
        $this->assertEquals('301000000000000032', $transaction->getColumnValue('notice_id'));
        $this->assertEquals('t0000000000000000000000000000032', $transaction->getColumnValue('token_ccp'));
        $this->assertEquals('AGID_01', $transaction->getColumnValue('id_psp'));
        $this->assertEquals('77777777777_01', $transaction->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $transaction->getColumnValue('canale'));
        $this->assertEquals('245.00', $transaction->getColumnValue('importo'));
    ...
    public function testTransactionDetails()
    {
        ...
        $this->assertEquals('75.00', $details->getColumnValue('amount_transfer'));
        $this->assertFalse($details->getColumnValue('is_bollo'));
    ...
    public function testWorkFlow()
    {
        ...
        $this->assertEquals('2024-03-10 13:30:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000048', $event->getColumnValue('event_id'));
        ...
        $this->assertEquals('2024-03-10 13:31:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000049', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        ...
        $this->assertEquals('2024-03-10 13:32:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000050', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        ...
        $this->assertEquals('2024-03-10 13:33:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000051', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        $this->assertEquals('OK', $event->getColumnValue('outcome'));
        ...
        $this->assertEquals('5', $event->getColumnValue('fk_tipoevento'));
        $this->assertEquals('2024-03-10 13:34:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000052', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        ...
        $this->assertEquals('6', $event->getColumnValue('fk_tipoevento'));
        $this->assertEquals('2024-03-10 13:35:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000053', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        $this->assertEquals('KO', $event->getColumnValue('outcome'));
        $this->assertEquals('PPT_ESITO_ACQUISITO', $event->getColumnValue('faultcode'));
    }

    #[TestDox('[ReEvent] Verifica stato evento')]
    public function testEvent()
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 48);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 49);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 50);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 51);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 52);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 53);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));
    }
}
