 ...
 *
 */
#[TestDox('[T00031] Valuta la corretta lavorazione di un workflow di pagamento MOD3 NEW con 2 transfer e una sendPaymentOutcome KO')]
class T00031_WorkflowPaymentMod3New2TransferSPOKO extends TestCase
{
    ...
    {
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-10'), '01000000000000031');

        $this->assertEquals('2024-03-10', $transaction->getColumnValue('date_event'));
        $this->assertEquals('2024-03-10 12:30:00.197', $transaction->getColumnValue('inserted_timestamp'));
        $this->assertEquals('01000000000000031', $transaction->getColumnValue('iuv'));
        $this->assertEquals('77777777777', $transaction->getColumnValue('pa_emittente'));
        $this->assertEquals('301000000000000031', $transaction->getColumnValue('notice_id'));
        $this->assertEquals('t0000000000000000000000000000031', $transaction->getColumnValue('token_ccp'));
    ...
    public function testTransactionDetails()
    {
        ...
        $this->assertEquals('85.00', $details->getColumnValue('amount_transfer'));
        $this->assertFalse($details->getColumnValue('is_bollo'));
    ...
    public function testWorkFlow()
    {
        ...
        $this->assertEquals('2024-03-10 12:30:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000044', $event->getColumnValue('event_id'));
        ...
        $this->assertEquals('2024-03-10 12:31:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000045', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        ...
        $this->assertEquals('2024-03-10 12:32:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000046', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
        ...
        $this->assertEquals('2024-03-10 12:33:00.197', $event->getColumnValue('event_timestamp'));
        $this->assertEquals('T000047', $event->getColumnValue('event_id'));
        $this->assertEquals('77777777777_01', $event->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01', $event->getColumnValue('canale'));
        $this->assertEquals('AGID_01', $event->getColumnValue('id_psp'));
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 44);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 45);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 46);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 47);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));
    }
}
