...
class T00009_CreatePaymentAlreadyPresenteInAnotherDayNotAllInfoInEvent extends TestCase
{
    ...
    public function testTransaction()
    {
        ...
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-11'), '01000000000000004');
        $this->assertEquals('2024-03-11', $transaction->getColumnValue('date_event'));
        $this->assertEquals('2024-03-11 09:42:25.232', $transaction->getColumnValue('inserted_timestamp'));
