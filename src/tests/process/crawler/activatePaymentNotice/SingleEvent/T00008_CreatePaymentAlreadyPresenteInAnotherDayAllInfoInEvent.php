 ...
 *            <td style="border-right: 1px dashed;padding: 8px">8</td>
 ...
 *
 */
#[TestDox('[T00008] Valuta la corretta lavorazione di una singola activatePaymentNotice Request con token assente, creando quindi un Payment già analizzato nel giorno precedente')]
class T00008_CreatePaymentAlreadyPresenteInAnotherDayAllInfoInEvent extends TestCase
{
    ...
    {
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-11'), '01000000000000003', 't0000000000000000000000000000001');
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-11'), 8);
