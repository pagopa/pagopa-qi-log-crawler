...
/**
 * <p>Valuta la corretta lavorazione di una singola activatePaymentNotice Request con alcune delle info nell'evento non presenti e già lavorata nel giorno precedente</p>
 *
 *
 * <h2>Event(s)</h2>
 ...
 *            <td style="border-right: 1px dashed;padding: 8px">7</td>
 ...
 *      <tbody>
 *          <tr style="border-bottom: 1px dashed;">
 *            <td style="border-right: 1px dashed;padding: 10px">T000007</td>
 *            <td style="border-right: 1px dashed;padding: 10px">1</td>
 *            <td style="padding: 10px">2024-03-11 09:49:25.232</td>
 *          </tr>
 *      </tbody>
 *      <tfoot>
 *          <tr style="padding: 10px">
 ...
 *
 */
#[TestDox('[T00007] Lavorazione di una activatePaymentNotice REQ con tutti i valori presenti nell\'evento e nel payload ma in giornata diversa')]
class T00007_CreateAttemptAlreadyPresentInAnotherDayNotAllInfo extends TestCase
{
    ...
    public function testTransaction()
    {
        ...
        $transaction = self::$db->getTransaction(new \DateTime('2024-03-11'), '01000000000000002', 't0000000000000000000000000000002');

        $this->assertEquals('2024-03-11', $transaction->getColumnValue('date_event'));
        $this->assertEquals('2024-03-11 09:49:25.232', $transaction->getColumnValue('inserted_timestamp'));
    ...
    public function testWorkflow()
    {
        ...
        $this->assertEquals('2024-03-11 09:49:25.232', $workflow->getColumnValue('event_timestamp'));
        $this->assertEquals('T000007', $workflow->getColumnValue('event_id'));
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-11'), 7);
