 ...
 *            <td style="border-right: 1px dashed;padding: 8px">12</td>
 *            <td style="border-right: 1px dashed;padding: 8px">activatePaymentNotice</td>
 *            <td style="padding: 8px">REQ</td>
 *          </tr>
 *          <tr style="border-bottom: 0px dashed;">
 *             <td style="border-right: 1px dashed;padding: 8px">13</td>
 *             <td style="border-right: 1px dashed;padding: 8px">activatePaymentNotice</td>
 ...
 *     <tbody>
 *         <tr style="border-bottom: 1px dashed;">
 *           <td style="border-right: 1px dashed;padding: 10px">01000000000000007</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 *           <td style="padding: 10px">t0000000000000000000000000000007</td>
 *         </tr>
 *     </tbody>
 *     <tfoot>
 ...
 *     <tbody>
 *         <tr style="border-bottom: 1px dashed;">
 *           <td style="border-right: 1px dashed;padding: 10px">50.00</td>
 *           <td style="border-right: 1px dashed;padding: 10px">77777777777</td>
 *           <td style="padding: 10px">IT18U0000000000000000000001</td>
 *         </tr>
 *         <tr style="border-bottom: 1px dashed;">
 *            <td style="border-right: 1px dashed;padding: 10px">30.00</td>
 ...
 *      <tbody>
 *          <tr style="border-bottom: 1px dashed;">
 *             <td style="border-right: 1px dashed;padding: 10px">T000011</td>
 *             <td style="border-right: 1px dashed;padding: 10px">1</td>
 *             <td style="padding: 10px">2024-03-10 10:31:00.197</td>
 *          </tr>
 *          <tr style="border-bottom: 1px dashed;">
 *             <td style="border-right: 1px dashed;padding: 10px">T000012</td>
...
#[TestDox('[T00012] Valuta la corretta lavorazione REQ/RESP activatePaymentNotice con tutte le info e 2 transfer')]
class T00012_CreateAttemptReqRespTwoTransferAllInfoEvent extends TestCase
{
    ...
    public function testTransaction()
    {
        ...
        $this->assertEquals('2024-03-10 10:31:00.197', $transaction->getColumnValue('inserted_timestamp'));
        $this->assertEquals('01000000000000007', $transaction->getColumnValue('iuv'));
        $this->assertEquals('77777777777', $transaction->getColumnValue('pa_emittente'));
        $this->assertEquals('301000000000000007', $transaction->getColumnValue('notice_id'));
        $this->assertEquals('t0000000000000000000000000000007', $transaction->getColumnValue('token_ccp'));
    ...
    {
        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 12);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));

        $event = self::$db->getReEvent(new \DateTime('2024-03-10'), 13);
        $this->assertEquals('LOADED', $event->getColumnValue('state'));
