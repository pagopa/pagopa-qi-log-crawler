...
#[TestDox('[CRAWLER] Lavorazione di una activatePaymentNotice REQ già lavorata ma in data diversa')]
class T0009 extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$workflow = new Workflow(new \DateTime('2024-03-11'), (array) $result->get(0));
        ...
        self::$re = new TransactionRe(new \DateTime('2024-03-11'), (array) $result->get(0));
    ...
    public function testCorrectWorkflowDateEvent()
    {
        ...
        $result = Capsule::table('transaction_2024')
            ->where('iuv', '=', '01000000000000006')
            ->where('token_ccp', '=', 't0000000000000000000000000000006')
            ->where('date_event', '=', '2024-03-11')
            ->get();

        $transaction = new Transaction(new \DateTime('2024-03-11'), (array) $result->get(0));
        ...
        $workflow = new Workflow(new \DateTime('2024-03-11'), (array) $result->get(0));

        $this->assertEquals('2024-03-11',$transaction->getColumnValue('date_event'));
        $this->assertEquals('2024-03-11 09:10:20.232',$transaction->getColumnValue('inserted_timestamp'));
        ...
        $this->assertEquals('2024-03-11', $workflow->getColumnValue('date_event'));
