...
#[TestDox('[CRAWLER] Lavorazione di una coppia di activatePaymentNotice REQ/RESP corrette ed 2 transfer con due RESP uguali')]
class T0013 extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $result = Capsule::table('transaction_2024')
            ->where('iuv', '=', '01000000000000012')
            ->where('token_ccp', '=', 't0000000000000000000000000000012')
            ->get();
    ...
    public function testCorrectDateEvent()
    {
        ...
        $this->assertEquals('2024-03-10 09:24:10.232',$transaction->getColumnValue('inserted_timestamp'));
