...
class T0011 extends TestCase
{
    ...
    public function testCorrectWorkflowDateEvent()
    {
        ...
        $this->assertEquals('PSP_01',$resp->getColumnValue('id_psp'));
        $this->assertEquals('77777777777_01',$resp->getColumnValue('stazione'));
        $this->assertEquals('88888888888_01',$resp->getColumnValue('canale'));
