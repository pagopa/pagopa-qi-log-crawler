...
class pspInviaCarrelloRPTCarte extends RequestXML
{
    const string XPATH_IUV                  = '//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT[%1$d]/identificativoUnivocoVersamento';
    const string XPATH_CREDITOR_REFERENCE   = '//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT[%1$d]/identificativoUnivocoVersamento';
    const string XPATH_PA_EMITTENTE         = '//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT[%1$d]/identificativoDominio';
    const string XPATH_TOKEN                = '//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT[%1$d]/codiceContestoPagamento';

    const string XPATH_PSP_ID               = '//pspInviaCarrelloRPTCarte/identificativoPSP';
    const string XPATH_BROKER_PSP           = '//pspInviaCarrelloRPTCarte/identificativoIntermediarioPSP';
    const string XPATH_BROKER_CHANNEL       = '//pspInviaCarrelloRPTCarte/identificativoCanale';

	public function getPaymentsCount(): int
	{
		return $this->getElementsCount('//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT');
	}
    ...
    {
        $index++;
        $xpath = vsprintf('//pspInviaCarrelloRPTCarte/listaRPT/elementoListaCarrelloRPT[%1$d]/rpt', [$index]);
