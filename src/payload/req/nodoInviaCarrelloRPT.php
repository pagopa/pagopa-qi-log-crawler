...
class nodoInviaCarrelloRPT extends RequestXML
{
    const string XPATH_IUV                  = '//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT[%1$d]/identificativoUnivocoVersamento';
    const string XPATH_CREDITOR_REFERENCE   = '//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT[%1$d]/identificativoUnivocoVersamento';
    const string XPATH_PA_EMITTENTE         = '//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT[%1$d]/identificativoDominio';
    const string XPATH_TOKEN                = '//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT[%1$d]/codiceContestoPagamento';

    const string XPATH_PSP_ID               = '//nodoInviaCarrelloRPT/identificativoPSP';
    const string XPATH_BROKER_PSP           = '//nodoInviaCarrelloRPT/identificativoIntermediarioPSP';
    const string XPATH_BROKER_CHANNEL       = '//nodoInviaCarrelloRPT/identificativoCanale';

    const string XPATH_BROKER_PA            = '//intestazioneCarrelloPPT/identificativoIntermediarioPA';
    const string XPATH_BROKER_STATION       = '//intestazioneCarrelloPPT/identificativoStazioneIntermediarioPA';

	public function getPaymentsCount(): int
	{
		return $this->getElementsCount('//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT');
	}
    ...
    {
        $index++;
        $xpath = vsprintf('//nodoInviaCarrelloRPT/listaRPT/elementoListaRPT[%1$d]/rpt', [$index]);
    ...
    /**
     * <p>Restituisce l'id carrello della nodoInviaCarrelloRPT</p>
     * @return string|null <p><code>null</code> Se il carrello non esiste (payload errato)</p>
     */
    public function getIdCarrello() : string|null
    {
        return $this->getElement('//intestazioneCarrelloPPT/identificativoCarrello');
    }
