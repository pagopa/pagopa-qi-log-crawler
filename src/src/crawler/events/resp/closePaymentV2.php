...
use pagopa\crawler\methods\resp\closePaymentV2 as Payload;
use pagopa\database\sherlock\Transaction;
use pagopa\database\sherlock\TransactionDetails;
use pagopa\database\sherlock\Workflow;

class closePaymentV2 extends AbstractEvent implements FaultInterface
{
    ...
    {
        // nella Resp non restituisco nulla tanto con la getCacheKeyList recupero il sessionIdOriginal
        // generato con la corrispondente Request
        return null;
    }
