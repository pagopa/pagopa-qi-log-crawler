...
use pagopa\sert\payload\req\paSendRTV2;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use PHPUnit\Framework\Attributes\TestDox;

#[TestDox('pagopa\sert\payload\req\paSendRTV2')]
#[CoversClass(paSendRTV2::class)]
class paSendRTV2Test extends TestCase
{
    protected paSendRTV2 $instance_1_transfer;

    protected paSendRTV2 $instance_1_transfer_t_metadata;

    protected paSendRTV2 $instance_1_transfer_p_metadata;

    protected paSendRTV2 $instance_1_transfer_t_metadata_p_metadata;

    protected paSendRTV2 $instance_2_transfer;

    protected paSendRTV2 $instance_2_transfer_t_metadata;

    protected paSendRTV2 $instance_2_transfer_p_metadata;

    protected paSendRTV2 $instance_2_transfer_t_metadata_p_metadata;

    protected paSendRTV2 $instance_2_transfer_1_bollo_t_metadata_p_metadata;

    protected function setUp(): void
    {
        $data = [
            'nav' => '301000000000000003',
        ...
        $this->instance_1_transfer = new paSendRTV2(getPayload('paSendRTV2','req', $data_1_transfer));
        ...
        $this->instance_1_transfer_t_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_1_transfer_t_metadata));
        ...
        $this->instance_1_transfer_p_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_1_transfer_p_metadata));
        ...
        $this->instance_1_transfer_t_metadata_p_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_1_transfer_t_metadata_p_metadata));
        ...
        $this->instance_2_transfer = new paSendRTV2(getPayload('paSendRTV2','req', $data_2_transfer));

        $data_2_transfer_t_metadata = $data;
        unset($data_2_transfer_t_metadata['metadata']);
        $this->instance_2_transfer_t_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_2_transfer_t_metadata));
        ...
        $this->instance_2_transfer_p_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_2_transfer_p_metadata));

        $data_2_transfer_t_metadata_p_metadata = $data;
        $this->instance_2_transfer_t_metadata_p_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_2_transfer_t_metadata_p_metadata));
        ...
        $this->instance_2_transfer_1_bollo_t_metadata_p_metadata = new paSendRTV2(getPayload('paSendRTV2','req', $data_2_transfer_1_bollo_t_metadata_p_metadata));
    ...
    {
        $this->assertEquals('301000000000000003', $this->instance_1_transfer->getNav());
        $this->assertEquals('301000000000000003', $this->instance_1_transfer_t_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_1_transfer_p_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_1_transfer_t_metadata_p_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_2_transfer->getNav());
        $this->assertEquals('301000000000000003', $this->instance_2_transfer_t_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_2_transfer_p_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_2_transfer_t_metadata_p_metadata->getNav());
        $this->assertEquals('301000000000000003', $this->instance_2_transfer_1_bollo_t_metadata_p_metadata->getNav());
    }
    ...
    public function testGetToken()
    {
        ...
        $this->assertEquals('t0000000000000000000000000000003', $this->instance_2_transfer_1_bollo_t_metadata_p_metadata->getToken());
    }
    ...
    public function testGetBrokerPa()
    {
        ...
        $this->assertEquals('77777777777', $this->instance_2_transfer_1_bollo_t_metadata_p_metadata->getBrokerPa());
    }
    ...
    public function testGetBrokerStation()
    {
        ...
        $this->assertEquals('77777777777_01', $this->instance_2_transfer_1_bollo_t_metadata_p_metadata->getBrokerStation());
    }
}
