...
use pagopa\sert\payload\req\pspInviaCarrelloRPT;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use PHPUnit\Framework\Attributes\TestDox;

#[TestDox('pagopa\sert\payload\req\pspInviaCarrelloRPT')]
...
class pspInviaCarrelloRPTTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new pspInviaCarrelloRPT(getPayload('pspInviaCarrelloRPT','req', $data));
    }
