...
use pagopa\sert\payload\resp\paGetPaymentV2;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use PHPUnit\Framework\Attributes\TestDox;

#[TestDox('pagopa\sert\payload\resp\paGetPaymentV2')]
#[CoversClass(paGetPaymentV2::class)]
class paGetPaymentV2Test extends TestCase
{

    protected paGetPaymentV2 $instance_1_transfer;

    protected paGetPaymentV2 $instance_1_transfer_t_metadata;

    protected paGetPaymentV2 $instance_1_transfer_p_metadata;

    protected paGetPaymentV2 $instance_1_transfer_t_metadata_p_metadata;

    protected paGetPaymentV2 $instance_2_transfer;

    protected paGetPaymentV2 $instance_2_transfer_t_metadata;

    protected paGetPaymentV2 $instance_2_transfer_p_metadata;

    protected paGetPaymentV2 $instance_2_transfer_t_metadata_p_metadata;

    protected paGetPaymentV2 $instance_2_transfer_1_bollo_t_metadata_p_metadata;

    protected paGetPaymentV2 $instance_fault;
    ...
    protected function setUp(): void
    {
        ...
        $this->instance_1_transfer = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_1_transfer));
        ...
        $this->instance_1_transfer_t_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_1_transfer_t_metadata));
        ...
        $this->instance_1_transfer_p_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_1_transfer_p_metadata));
        ...
        $this->instance_1_transfer_t_metadata_p_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_1_transfer_t_metadata_p_metadata));
        ...
        $this->instance_2_transfer = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_2_transfer));

        $data_2_transfer_t_metadata = $data;
        unset($data_2_transfer_t_metadata['metadata']);
        $this->instance_2_transfer_t_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_2_transfer_t_metadata));
        ...
        $this->instance_2_transfer_p_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_2_transfer_p_metadata));

        $data_2_transfer_t_metadata_p_metadata = $data;
        $this->instance_2_transfer_t_metadata_p_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_2_transfer_t_metadata_p_metadata));
        ...
        $this->instance_2_transfer_1_bollo_t_metadata_p_metadata = new paGetPaymentV2(getPayload('paGetPaymentV2','resp', $data_2_transfer_1_bollo_t_metadata_p_metadata));

        $this->instance_fault = new paGetPaymentV2(getPayload('paGetPaymentV2','fault', ['code' => 'PPT_TOKEN_SCADUTO', 'string' => 'Token scaduto', 'description' => 'Token scaduto']));
    }
