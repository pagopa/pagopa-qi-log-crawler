...
use pagopa\sert\payload\resp\paaVerificaRPT;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use PHPUnit\Framework\Attributes\TestDox;

#[TestDox('pagopa\sert\payload\resp\paaVerificaRPT')]
...
class paaVerificaRPTTest extends TestCase
{
    ...
    protected paaVerificaRPT $instance_fault;
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new paaVerificaRPT(getPayload('paaVerificaRPT','resp', $data_1));
        $this->instance_fault = new paaVerificaRPT(getPayload('paaVerificaRPT','fault', ['code' => 'PPT_TOKEN_SCADUTO', 'string' => 'Token scaduto', 'description' => 'Token scaduto']));
    }
